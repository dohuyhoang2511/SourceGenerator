...
//                     string str2 = string.Join(", ", methodSymbol.Parameters.Select(it => $"{MapRefKind(it.RefKind)}{it.Type} {it.Name}"));
//                     string str3 = string.Join(", ", methodSymbol.Parameters.Select(it => $"{MapRefKind(it.RefKind)}{it.Name}"));
